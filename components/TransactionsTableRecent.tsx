...
const TransactionsTableRecent = ({ transactions }: TransactionTableProps) => {
    return (
        <Table>
            ...
            <div className={cn('category-badge border-green-900')}>
              ...
              <p className={cn('text-[12px] font-medium text-green-800')}>Payment</p>
                ...
                <TableRow className="px-2 text-left bg-red-100">
                    ...
                    <TableCell>
                        <div className={cn('category-badge border-blue-900')}>
                            <div className={cn('size-2 rounded-full bg-blue-500')} />
                            <p className={cn('text-[12px] font-medium text-blue-800')}>Clothes</p>
                        </div>
                    </TableCell>
...
export default TransactionsTableRecent